...
public final class PopularCategoryQuery: GraphQLQuery {
  /// The raw GraphQL definition of this operation.
  public let operationDefinition: String =
    """
    query PopularCategory($cursor: String) {
      movies {
        __typename
  ...
  public let operationName: String = "PopularCategory"

  public let operationIdentifier: String? = "b069bb1a701d6e2cb852cf05016b255388599ec5ccfec81e49a18c24921f4367"
    ...
    public struct Movie: GraphQLSelectionSet {
      ...
      public static var selections: [GraphQLSelection] {
        return [
          ...
          GraphQLField("popular", arguments: ["after": GraphQLVariable("cursor")], type: .nonNull(.object(Popular.selections))),
        ]
      }
