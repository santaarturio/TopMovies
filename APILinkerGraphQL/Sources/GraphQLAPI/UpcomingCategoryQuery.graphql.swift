...
public final class UpcomingCategoryQuery: GraphQLQuery {
  /// The raw GraphQL definition of this operation.
  public let operationDefinition: String =
    """
    query UpcomingCategory($cursor: String) {
      movies {
        __typename
        upcoming(after: $cursor) {
          __typename
  ...
  public let operationName: String = "UpcomingCategory"

  public let operationIdentifier: String? = "f74131cb0c281142c3a7d384d402ae65fa90b5e36b7eabdd003cc568568f8e8c"
    ...
    public struct Movie: GraphQLSelectionSet {
      ...
      public static var selections: [GraphQLSelection] {
        return [
          ...
          GraphQLField("upcoming", arguments: ["after": GraphQLVariable("cursor")], type: .nonNull(.object(Upcoming.selections))),
        ]
      }
      ...
      public init(upcoming: Upcoming) {
        self.init(unsafeResultMap: ["__typename": "Movies", "upcoming": upcoming.resultMap])
      }
